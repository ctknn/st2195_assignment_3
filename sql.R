...
dbWriteTable(conn, "airports", airports) #database management not needed  
dbWriteTable(conn, "carriers", carriers) #database management not needed
dbWriteTable(conn, "planes", planes) #database management not needed
